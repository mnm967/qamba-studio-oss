      ...
      footer={
        <>
          ...
          <button
            ...
            disabled={busy}
          >
            {busy ? <Loader2 size={14} className="ns-spin" /> : <Trash2 size={14} />} Delete project
          </button>
        </>
      }
    >
      <div className="ws-modal-body" style={{ display: "flex", flexDirection: "column", gap: 14, padding: "16px 20px" }}>
        <p style={{ fontSize: 13.5, color: "#c8cfdb", lineHeight: 1.6, margin: 0 }}>
          Are you sure you want to delete <b style={{ color: "#fff" }}>“{title}”</b>? This will permanently remove all associated episodes, storyboards, generation blocks, lore documents, and timeline clips.
        </p>
